...
paths: ["master_supporting_docs/**/*.tex", "master_supporting_docs/**/*.md", "Slides/**/*.tex", "Slides/**/*.qmd", "*.tex", "*.md"]
---
...
- Numeric claims in text (ATT, coefficients, N, p-values) **combined with** a sibling `scripts/R/` or `scripts/python/` directory
...
- `.agents/skills/review-paper/SKILL.md` — the orchestrator.
- `.agents/skills/review-r/SKILL.md` — code reviewer.
- `.agents/skills/audit-reproducibility/SKILL.md` — numeric claims verifier.
- `.codex/guidance/replication-protocol.md` — tolerance contract.

## What this rule does NOT require

- Running R or Python (that is `$audit-reproducibility`'s job, and it reads existing outputs).
