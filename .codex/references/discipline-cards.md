...
- Code: R, Python, and Julia all accepted; replication packages must be self-contained and deterministic (`set.seed`).
...
- Code: R is dominant; Python is common for text-as-data work.
...
- **File:** `.codex/references/discipline-cards.md`
- **Schema parallel:** `.codex/references/journal-profiles.md` (per-journal) and `.codex/references/audit-pet-peeves.md` (living-catalogue format).
